...
import UserDetailsSidebar from "./UserDetailSideBar";
...
const TableWithPagination: React.FC<TableWithPaginationProps> = ({
  ...
  return (
    <Card className="overflow-x-auto p-0 bg-white">
      ...
      <div className="flex items-center justify-between p-4 border-t-[1px] border-gray-300">
